...
export default function ProfileClient({ address }: ProfileClientProps) {
  ...
  const { listings: myArtistListings, isLoading: loadingArtist } =
    useArtistListings(isOwnProfile ? publicKey : address);
          ...
          <div className="grid grid-cols-2 gap-6 md:gap-8">
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-2 text-mint-400 font-bold text-2xl mb-1">
                ...
                {royaltyStats?.totalEarned
                  ? parseFloat(royaltyStats.totalEarned).toFixed(2)
                  : "0"}{" "}
                XLM
              </div>
              <p className="text-[10px] uppercase tracking-widest text-white/30 font-black">
                ...
                {purchasedArtworks.length > 0 ? (
                  ...
                  <div className="text-center py-20">
                    ...
                    <p className="text-white/20 text-sm mt-2">
                      Start building your collection from African artists
                    </p>
                  </div>
                )}
              </div>
                  ...
                  <div className="text-center py-20">
                    ...
                    <p className="text-white/20 text-sm mt-2">
                      {isOwnProfile
                        ...
                        : "This artist has no active listings"}
                    </p>
                  </div>
                )}
              </div>
